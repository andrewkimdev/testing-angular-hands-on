...
/**
 * Finds a form control explicitly or by name for the ControlController
 *
 * @param control An existing form control, as passed with the formControl directive
 * @param controlName A form control name, as passed with the formControlName directive
